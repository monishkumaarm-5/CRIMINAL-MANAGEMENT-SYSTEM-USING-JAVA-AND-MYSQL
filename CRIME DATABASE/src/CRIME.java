...
public class CRIME extends JFrame implements ActionListener
{
    ...
    Font font3 =new Font("Times New Roman",Font.PLAIN,32);
    Color DarkBlue=new Color(0,23,45);
    public void login()
    {   
    ...
    private JButton SHOWVICTIMSBUTTON =new JButton("SHOW A VICTIMBUTTON");
    ...
    public void dashboard()
    {
        ...
        dashboardFrame.add(CHECKINGFIRBUTTON);
    ...
    JLabel criminalrecordtitle=new JLabel("CRIMINAL RECORDS");
    ...
    public void actionPerformed (ActionEvent e)
    {
         ...
         if (e.getSource() == UPDATEBUTTON) {
            ...
            nextButton.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    String idReceived = idTextField.getText();
                    ...
                    if (selectedOption.equals("CRIMINAL_RECORDS")) 
                    {
                        ...
                        // Handle victim records similarly if needed
                    }
                }
            });
        }
        ...
        if(e.getSource()==editbutton)
        {
            ...
            try{
                ...
                FileInputStream imageFileInputStream=new FileInputStream(imagefile);
                prepareStatement=connection.prepareStatement("update criminal_record set Criminalname=?,dateofbirth=?,gender=?, address=?,image=?");
                prepareStatement.setString(1,criminialnamereceived);
                prepareStatement.setString(2,criminaldobreceived);
                prepareStatement.setString(3,criminalgenderreceived);
                prepareStatement.setString(4,criminaladdressreceived);
                prepareStatement.setBlob(5,imageFileInputStream);
                prepareStatement.executeUpdate();  
            }
            catch(SQLException|IOException ex)
            {
